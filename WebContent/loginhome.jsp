...
function locate() {
	window.location="http://localhost:8080/SEProject/room.jsp";
}

</script>
<input type="text" name="email" readonly="readonly" value="<%=(request.getSession().getAttribute("email") == null) ? "" : (String) request.getSession().getAttribute("email")%>" hidden>
...
<%@include file="includes/lognavbar.jsp"%>
...
<input type="date" name="checkin" class="col-lg-2 mb-2" onfocus= "(this.type='date')" value="${checkin }" required>
<span class="col-lg-2 text-end">Check Out</span>
<input type="date" name="checkout" class="col-lg-2 mb-2" onfocus= "(this.type='date')" value="${checkout }" required>
...
<div class="d-flex bd-highlight"id="font" style="margin-top: 80px;">
  <div class="p-2 flex-fill bd-highlight" ><img src="https://drive.google.com/uc?id=1paNDlbRNLzHndiBb2Q2voK6Vye9-uwuk" style="padding-left:25%; padding-bottom:20%; margin-top:3.5%; width:650px; height:455px;"></div>
...
<div class="container">
		...
		<div class="card col-lg-2" style="margin-right: 2%;">
  			<div class="card-body" id="icon">
    			<i class="fa fa-wifi" style="font-size: 70px; margin-right: 100px;"></i>
    			<h5 class="text-center">Free WiFi</h5>
  			</div>
		</div>
		<div class="card col-lg-2" style="margin-right: 2%;">
  			<div class="card-body" id="icon">
    			<i class="fa fa-car" style="font-size: 70px; margin-right: 100px;"></i>
